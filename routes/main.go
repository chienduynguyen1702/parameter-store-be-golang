...
func SetupV1Router() *gin.Engine {
	...
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://localhost:3000", "https://parameter-store-fe-golang.up.railway.app", os.Getenv("HOSTNAME_URL"), "https://param-store.datn.live", "http://localhost:" + os.Getenv("PORT")},
