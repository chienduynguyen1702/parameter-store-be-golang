...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/projects/github/repositories": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "List Repository By Github User Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.ListRepositoryByGithubUserRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "500": {
                        "description": "{\"error\": \"Failed to list repository by github user\"}",
                        "schema": {
                            "type": "string"
                        }
                    }
    ...
    "definitions": {
        ...
        "controllers.ListRepositoryByGithubUserRequest": {
            "type": "object",
            "required": [
                "token",
                "username"
        ...
        "models.Parameter": {
            ...
            "properties": {
                ...
                "stage": {
                    "description": "UpdatedBy   User\t\t` + "`" + `gorm:\"foreignKey:UpdatedBy\" json:\"updated_by\"` + "`" + ` // foreign key to user model",
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.Stage"
                        }
